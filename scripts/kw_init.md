...
- **BAN cross-domain high-frequency tokens (2026-09-08 Snag 实证)**: words whose core window is a generic transaction/action verb (give away, buy, get, find, sell, marketplace, free stuff, deals) FTS-match marketing/startup chatter across unrelated subreddits (DigitalMarketing/indiehackers/SaaS/SEO pull "give away your best stuff" / "nothing to buy"). A word is dangerous when its most distinctive token is a generic verb/noun used everywhere; safe words carry a **domain-specific noun** (furniture, couch, crib, declutter, freecycle, curb) that anchors the phrase to the product's scene. "give away furniture" → anchor is furniture but the verb window still hits marketing noise — prefer the noun-anchored form ("free furniture pickup", "declutter furniture", "curb alert"). When a domain noun and a generic token both appear, the phrase must keep the domain noun AND avoid the generic token as a standalone window.
